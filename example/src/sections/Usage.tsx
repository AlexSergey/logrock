...
export default function Usage() {
  return (
    <>
      ...
      <br />
      <p>
        <strong>2. ES6 and CommonJS builds are available with each distribution. For example:</strong>
      </p>
      <Code height="auto" width="100%" value={`import logger, { LoggerContainer, LoggerContext } from 'logrock'`} />
      <p>
        <strong>3. You need to wrap your app with {'<LoggerContainer>'}</strong>
      </p>
      <Code
        height="auto"
        width="100%"
