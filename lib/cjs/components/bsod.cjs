...
var _errorHelpers = require("../helpers/error-helpers.cjs");
...
const Bsod = props => {
  ...
  const cError = lastAction && _index.LoggerLevels.critical in lastAction ? lastAction[_index.LoggerLevels.critical] : undefined;
  let t0;
  let t1;
  ...
  let t2;
  if ($[2] !== props.onClose) {
    t2 = typeof props.onClose === "function" && /*#__PURE__*/(0, _jsxRuntime.jsx)("button", {
  ...
  let t3;
  if ($[4] !== cError) {
    t3 = cError && /*#__PURE__*/(0, _jsxRuntime.jsx)("h2", {
      style: {
        background: "#b3b3b3",
        color: "#00a",
  ...
  let t5;
  if ($[7] !== cError) {
    t5 = cError && Array.isArray(cError.stack) && /*#__PURE__*/(0, _jsxRuntime.jsxs)("pre", {
      style: {
        background: "none",
        border: 0,
  ...
  if ($[9] === Symbol.for("react.memo_cache_sentinel")) {
    t6 = _h || (_h = /*#__PURE__*/(0, _jsxRuntime.jsx)("h4", {
      children: "Actions:"
    }));
    $[9] = t6;
  } else {
  ...
  if ($[10] !== actions || $[11] !== props.count) {
    t7 = actions.length > 0 ? /*#__PURE__*/(0, _jsxRuntime.jsx)("ol", {
      reversed: true,
  ...
  if ($[16] !== t2 || $[17] !== t3 || $[18] !== t8) {
    t9 = /*#__PURE__*/(0, _reactDom.createPortal)(/*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
      style: t0,
...
var _default = exports.default = Bsod;
function _temp(action) {
  ...
  return !(0, _errorHelpers.isCritical)(type);
}
